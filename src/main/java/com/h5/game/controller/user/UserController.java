...
public class UserController extends BaseController{
    ...
    @ResponseBody
    public Map uploadGame(@RequestValidate GameVo gameVo, HttpSession session, HttpServletRequest request) {

        User user = authService.getUser(session);
        String gameDir = session.getServletContext().getRealPath("/game/");
